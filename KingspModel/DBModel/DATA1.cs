...
{
	[MetadataType(typeof(DATA1Metadata))]
	public partial class DATA1
	{
		#region Metadata
		private class DATA1Metadata : BaseMetadata
		{
		...
		{
			return this.PLUS.FirstOrDefault(p => p.ORDER == order);
		}

		public PLUS GetPlusByType(string type)
		{
			return this.PLUS.FirstOrDefault(p => p.PLUS_TYPE == type);
		}
        ...
        {
            return this.CONTENT11.ToSplit().ToList();
        }
        ...
        /// <summary>
		/// 取得PLUS
		/// <para>預設取得 訂單 資料</para>
		/// </summary>
		/// <param name="pt">fun4000 = 訂單管理</param>
		/// <returns></returns>
		public List<PLUS> GetPlusList(string pt = "fun4000")
        {
		...
		/// <param name="pt">fun4000 = 訂單管理</param>
		/// <returns></returns>
		public bool HasPlusList(string pt = "fun4000")
        {
