...
namespace KingspModel.com.every8d.api {
    ...
    public partial class SMS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SMS() {
            this.Url = global::KingspModel.Properties.Settings.Default.KingspModel_com_every8d_api_SMS;
        ...
        /// <remarks/>
        public void sendMessageAsync(string sessionKey, string subject, string content, string mobile, string sendTime, string retryTime) {
            this.sendMessageAsync(sessionKey, subject, content, mobile, sendTime, retryTime, null);
        }
        
        /// <remarks/>
        public void sendMessageAsync(string sessionKey, string subject, string content, string mobile, string sendTime, string retryTime, object userState) {
            ...
            this.InvokeAsync("sendMessage", new object[] {
                        ...
                        mobile,
                        sendTime,
                        retryTime}, this.sendMessageOperationCompleted, userState);
        }
