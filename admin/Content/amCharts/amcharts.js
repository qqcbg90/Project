    ...
    d.ValueAxis = d.Class({
        ...
        draw: function () {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                !0 === h ? (w = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E,
                            ...
                            !this.integersOnly || Math.round(t) == t)
                                if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
                                    ...
                                    if (!isNaN(z) && 0 < A && g < r - 1) {
                                        f = y / z;
                                        h && (z = y * (g + p) + this.minCalc,
                                        z = d.roundTo(z, this.maxDecCount + 1),
                                        w > this.logGridLimit && (z = Math.pow(10, g + p)),
                                        f = 9,
                                        z = (z - t) / f);
                                        K = this.gridAlpha;
                                        this.gridAlpha = this.minorGridAlpha;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            "V" == Pa && (n = 0);
            var ca;
            P && "" !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(y, c, w, t, r, ga, k, Math.abs(h), 0) : d.text(y, c, w, t, r, ga, k),
            ga = ca.getBBox(),
            ha = ga.width,
            Qa = ga.height);
            if ("H" == Pa) {
    ...
    d.AmGraph = d.Class({
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                    ...
                                    if (t) {
                                        ...
                                        J = d.roundTo(J, 2);
                                        ba = d.roundTo(ba, 2);
                                        R < q && 0 < J && (va = new d.Cuboid(h, ba, J, H - a.d3x, Q - a.d3y, Na, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa),
                                        ...
                                        va = new d.Cuboid(h, J, ba, H - a.d3x, Q - a.d3y, Na, Va, da, Ca, this.lineAlpha, ga, w, t, ea, bb, mb, aa),
                            ...
                            if (!isNaN(ua) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (S < n && 0 < J) {
                                        ...
                                        Hb = [N, ra]) : (Gb = [N, ta],
                                        Hb = [F, ra]);
                                        !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Xa = d.line(h, [E, E], Gb, Ca, X, da),
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                if (0 < g || 0 < A)
                    ...
                    0 < g && (b = d.polygon(l, p, r, w, g, 1, "#000", 0, a, f),
        ...
        drawSmoothedGraph: function (a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== r && (n = new d.Bezier(g, a, b, r, A, n, t, 0, h, void 0, u),
                ...
                n += " L" + a[0] + "," + x),
                n += " L" + a[0] + "," + b[0]),
                c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, u),
                d.setCN(f, c, this.bcn + "fill"),
                c.path.pattern(this.pattern, NaN, f.path),
                k.push(c.path),
                w || void 0 !== r) && (y || (y = q),
                w || (w = r),
                a = new d.Bezier(g, a, b, NaN, 0, 0, w, y, h, n, u),
        ...
        showGraphBalloon: function (a, b, c, e, h) {
            if (a) {
                ...
                if (g && g.enabled && this.showBalloon && !this.hidden) {
                    ...
                    g.fixPrevious(),
                    g.fixedPosition && (c = !1),
                    !c && "radar" != f.type && (b < k || b > a + k || h < l - .5 || h > q + l) ? (g.showBalloon(m),
...
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        updateDragIconPositions: function () {
            ...
            e.translate((k - g) / 2, c - f / 2),
            d.translate((k - g) / 2, c + a.height - f / 2)) : (f = this.dragIconHeight,
            g = this.dragIconWidth,
            e.translate(b - g / 2, (k - f) / 2),
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.showBullet && (I = d.circle(h, ia, t, w),
                    f.push(I));
                    this.drop ? (g = C / 1.6,
                    l = 0,
                    "V" == x && (x = "down"),
                    ...
                    k = z - H / 2 + 1,
                    m = D - K / 2 - 1,
                    q = d.drop(h, g, l, q, w, r, p, aa)) : 0 < u || 0 === y ? (0 < M && (a = d.rect(h, C, A, q, 0, r + 1, P, M, u),
                    d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                    f.push(a)),
                    q = d.rect(h, C, A, q, w, r, p, aa, u)) : (t = [],
                    u = [],
                    "H" != x ? (g = a - D,
                    g > C - y && (g = C - y),
                    g < y && (g = y),
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            P = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
            y ? (M || (P += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + D + "," + (C + l)),
            P += " L" + K + "," + (u + l),
            0 < k && (M || (P += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," + (l + c + w) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (P += " A" + f + "," + g + ",0," + Q + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l),
        ...
        y ? (M || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(B) + "," + r(D) + "," + r(C)),
        g = " M" + r(x) + "," + r(A) + " L" + r(z) + "," + r(B) + h + " L" + r(K) + "," + r(u)) : g = " M" + x + "," + A + " L" + z + "," + B + (" A" + f + "," + g + ",0," + Q + ",1," + D + "," + C) + " L" + K + "," + u;
...
(function () {
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n) {
            var q, p;
            "object" == typeof g && 1 < g.length && (p = !0,
            q = g,
            g = g[0]);
...
(function () {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function () {
            ...
            f.className = "amChartsLegend color_c " + a.classNamePrefix + "-legend-div");
            this.divWidth = c;
            ...
            if (a)
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e)
                        ...
                        h.text(g);
                        if (!f.pattern && (this.useMarkerColorForValues && h.setAttr("fill", n),
